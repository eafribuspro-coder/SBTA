/*
  # Correction de l'insertion dans fuel_vouchers

  1. Modifications
    - Mise à jour de la fonction pour utiliser les vraies colonnes de fuel_vouchers
    - estimated_amount au lieu de estimated_total
    - Suppression de route_id et departure_mileage qui n'existent pas
*/
